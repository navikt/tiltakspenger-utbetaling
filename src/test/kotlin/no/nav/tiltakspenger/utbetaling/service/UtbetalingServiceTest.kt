...
import no.nav.tiltakspenger.utbetaling.client.iverksett.IverksettMapper.mapIverksettDTO
...
class UtbetalingServiceTest {
    ...
    fun `sjekk slå sammen perioder`() {
        ...
        val vedtak = Vedtak(
            ...
            utbetalinger = listOf(
                UtbetalingDag(
                    dato = 1.januar(),
                    tiltaktype = TiltakType.ENKELAMO,
                    status = UtbetalingDagStatus.FullUtbetaling,
                ...
                UtbetalingDag(
                    dato = 2.januar(),
                    tiltaktype = TiltakType.ENKELAMO,
                    status = UtbetalingDagStatus.DelvisUtbetaling,
                    meldekortId = meldekortId,
                    løpenr = løpenr,
                ),
                UtbetalingDag(
                ...
                UtbetalingDag(
                    dato = 6.januar(),
                    tiltaktype = TiltakType.GRUPPEAMO,
                    status = UtbetalingDagStatus.FullUtbetaling,
                    meldekortId = meldekortId,
                    løpenr = løpenr,
                ),
                ...
                UtbetalingDag(
                    dato = 9.januar(),
                    tiltaktype = TiltakType.ENKELAMO,
                    status = UtbetalingDagStatus.IngenUtbetaling,
                    meldekortId = meldekortId,
                    løpenr = løpenr,
                ),
                UtbetalingDag(
        ...
        dto.vedtak.utbetalinger shouldContainExactlyInAnyOrder listOf(
            UtbetalingDto(
                beløpPerDag = sats.sats,
                fraOgMedDato = 1.januar(),
                tilOgMedDato = 1.januar(),
                stønadsdata = enkeltAmoUtenBarn(),
            ),
            UtbetalingDto(
                beløpPerDag = sats.satsDelvis,
                fraOgMedDato = 2.januar(),
                tilOgMedDato = 3.januar(),
                stønadsdata = enkeltAmoUtenBarn(),
            ),
            UtbetalingDto(
                beløpPerDag = sats.sats,
                fraOgMedDato = 4.januar(),
                tilOgMedDato = 5.januar(),
                stønadsdata = enkeltAmoUtenBarn(),
            ),
            UtbetalingDto(
                beløpPerDag = sats.sats,
                fraOgMedDato = 6.januar(),
                tilOgMedDato = 6.januar(),
                stønadsdata = gruppeAmoUtenBarn(),
            ),
            UtbetalingDto(
                beløpPerDag = sats.sats,
                fraOgMedDato = 7.januar(),
                tilOgMedDato = 8.januar(),
                stønadsdata = enkeltAmoUtenBarn(),
            ),
            UtbetalingDto(
                beløpPerDag = sats.sats,
                fraOgMedDato = 11.januar(),
                tilOgMedDato = 11.januar(),
                stønadsdata = enkeltAmoUtenBarn(),
            ),
        )
    }
    ...
    fun `sjekk slå sammen perioder med 2 barn`() {
        ...
        dto.vedtak.utbetalinger shouldContainExactlyInAnyOrder listOf(
            ...
            UtbetalingDto(
                beløpPerDag = sats.satsBarnetillegg * 2,
                fraOgMedDato = 1.januar(),
                tilOgMedDato = 1.januar(),
                stønadsdata = enkeltAmoMedBarn(),
            ),
            UtbetalingDto(
                beløpPerDag = sats.satsBarnetilleggDelvis * 2,
                fraOgMedDato = 2.januar(),
                tilOgMedDato = 3.januar(),
                stønadsdata = enkeltAmoMedBarn(),
            ),
    ...
    fun `sjekk at perioder ikke går på tvers av meldekort`() {
        ...
        dto.vedtak.utbetalinger shouldContainExactlyInAnyOrder listOf(
            ...
            UtbetalingDto(
                beløpPerDag = sats.sats,
                fraOgMedDato = 9.januar(),
                tilOgMedDato = 12.januar(),
                stønadsdata = enkeltAmoUtenBarn(),
            ),
            UtbetalingDto(
                beløpPerDag = sats.sats,
                fraOgMedDato = 16.januar(),
                tilOgMedDato = 19.januar(),
                stønadsdata = enkeltAmoUtenBarn(),
            ),
            UtbetalingDto(
                beløpPerDag = sats.sats,
                fraOgMedDato = 23.januar(),
                tilOgMedDato = 26.januar(),
                stønadsdata = enkeltAmoUtenBarn(),
            ),
        )
    }
