...
object VedtakDTOMapper {
    fun mapVedtak(vedtak: Vedtak): VedtakDTO {
        ...
        val førsteUtbetalingsDag =
            utbetalingerForSisteLøpenummer.minByOrNull { it.dato }?.dato ?: LocalDate.of(1970, 1, 1)
        val sisteUtbetalingsDag =
            utbetalingerForSisteLøpenummer.maxByOrNull { it.dato }?.dato ?: LocalDate.of(9999, 12, 31)
